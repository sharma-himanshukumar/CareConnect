...
# MAGIC %md
# MAGIC # Created Delta table, this is not executed at all, do not run this.
...
# MAGIC %pip install --upgrade --force-reinstall databricks-vectorsearch openai
...
schema_name = "default"
source_table_name = "vector_index_medical_prescription"
